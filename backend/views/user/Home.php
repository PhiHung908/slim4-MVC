...
<div class="row justify-content-center">
	<div class="col col-md-6 pt-5">
		...
		<p>
			...
			<br><a href="<?= $this->urlTo('row/2') ?>" >View row id=2</a>
			<br><a href="<?= $this->urlTo('row/1') ?>" >View row id=1</a>
			<br><a href="<?= $this->urlTo('row?id=1&k=<script>alert(1);</script>&n=javascript:alert(2);') ?>" >View row id=1</a>
						<br><a href="<?= $this->urlTo('javascript:alert(2);') ?>" >View row id=1</a>
		...
		<p>
			<a href="<?= $this->urlGo('https://google.com') ?>" >Redirect to Google</a>
		</p>
